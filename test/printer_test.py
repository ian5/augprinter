...
import printer.printcore as printcore

@pytest.mark.parametrize('standard_path,carddefinition', [
    ('test/example/sigiltester.png', {'portrait': 'assets/art/Skeleton.png', 
    'background': 'assets/bg/bg_common_undead.png', 
    'frame': 'assets/frames/frame_common_undead.png', 'mainbody': [
    ...
    'tribes': ['Test Card'], 'rarity': 'Fake As Shit', 'temple': 'Undead', 
    'power': 1, 'health': 1, 'name': 'Sigil Tester', 
    'artist': 'PixelProfligate', 'costs': [], 'format': 'TEST'}),
    ('test/example/bodyitemtester.png', {
        'portrait':'assets/art/Child 13.png', 'background':'assets/bg/bg_rare_beast.png', 'frame':'assets/frames/frame_rare_beast.png', 'artist':'Raytheon',
                'tribes':['Hooved', 'Cryptid'], 'rarity':'Fake As Shit', 'temple':'Beast', 'power':4, 'health':4, 'name':'BodyItem Tester', 'costs':[(Cost('assets/cost/blood.png', 5), 1)], 'format':'TEST',
                'mainbody' : [  
    ...
    ('test/example/othertester.png', {
        'portrait':'assets/art/Skel-e-latcher.png', 'background':'assets/bg/bg_common_magick.png', 'frame':'assets/frames/frame_common_magick.png', 'artist':'Raytheon',
                'tribes':['Latcher'], 'rarity':'Fake As Shit', 'temple':'Tech', 'power':'assets/variable/Mirror Power.png', 'health':1, 'name':'OtherTester', 'costs':[(Cost('assets/cost/energy.png', 7), 5), (Cost('assets/cost/overcharge.png', 7), 2)], 'format':'TEST',
