...
# cards.append(assemble_card(portrait='assets/art/Skeleton.png', background='assets/bg/bg_common_undead.png', frame='assets/frames/frame_common_undead.png',
#               mainbody=[
...
#               ],
#               tribes=['Skeleton'], tier='Side Deck', temple='Undead', power=0, health=1, name='Skeleton', artist='Vivziepop', costs=[])
# )
# cards.append(assemble_card(portrait='assets/art/Child 13.png', background='assets/bg/bg_rare_beast.png', frame='assets/frames/frame_rare_beast.png', artist='Raytheon',
...
#               ])
# )
# cards.append(assemble_card(portrait='assets/art/Skel-e-latcher.png', background='assets/bg/bg_common_magick.png', frame='assets/frames/frame_common_magick.png', artist='Raytheon',
...
#     card.save('output/{}.png'.format(num))
